...
sprite_rect = sprite_image.get_rect(centerx=280, centery=700)
# 1спрайт
q = pygame.image.load('пом.webp')
qr = q.get_rect(centerx=170, centery=150)
# 2 спрайт
s = pygame.image.load('пом.webp')
sr = s.get_rect(centerx=140, centery=100)
# 3спрайт
w = pygame.image.load('пом.webp')
wr = s.get_rect(centerx=120, centery=150)
# 4 спрайт
e = pygame.image.load('глаз.webp')
er = e.get_rect(centerx=125, centery=145)
# 5 спрайт
r = pygame.image.load('мяс.webp')
rr = r.get_rect(centerx=380, centery=145)
# 6 спрайт
t = pygame.image.load('мяс.webp')
tr = r.get_rect(centerx=420, centery=110)
# 7 спрайт
a = pygame.image.load('мяс.webp')
ar = r.get_rect(centerx=450, centery=170)
# 8 спрайт
f = pygame.image.load('колбаса.webp')
fr = s.get_rect(centerx=640, centery=100)
# 9 спрайт
g = pygame.image.load('колбаса.webp')
gr = s.get_rect(centerx=670, centery=150)
# 10 спрайт
h = pygame.image.load('чили.webp')
hr = s.get_rect(centerx=670, centery=700)
# 11 спрайт
j = pygame.image.load('огурец.webp')
jr = s.get_rect(centerx=110, centery=660)
# 12 спрайт
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            if button_rect.collidepoint(event.pos):
                video_clip = VideoFileClip("ФИНААЛ.mp4")
                video_clip.preview()
